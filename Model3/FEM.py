...
Knotenlasten["P2_y"] = -5. 
Knotenlasten["P4_x"] = 8. 
Knotenlasten["P7_x"] = 10. 
Knotenlasten["P7_y"] = -10. 
Knotenlasten["P11_x"] = 20. 
Knotenlasten["P12_x"] = 15. 
Knotenlasten["P12_y"] = -5. 
...
with open("results_model_3v1.txt", "a") as output:

	output.write("Knotenverschiebungsvektor v:\n\n")
	output.write(str(np.matrix(v)))
	output.write("\n\n")

	output.write("Lagerreaktionskräfte p (Vorsicht Knotenlasten sind noch drin):\n\n")
